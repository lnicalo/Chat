...
Programa que espera conexiones de clientes como climess en el puerto especificado. Puede atender a varios clientes a la vez. Se espera un login que es del remitente. Luego otro que es el destinatario. A continuación se lee el mensaje y se guarda en un fichero con el nombre del destinatario. Para terminar informa del resultado de la operación.
